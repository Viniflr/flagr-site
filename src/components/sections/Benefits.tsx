...
const Benefits: React.FC = () => {
  return (
    ...
    >
      ...
      <div className="flex flex-wrap md:flex-nowrap justify-center gap-6 w-full max-w-[1567px] mt-10 md:mt-[124px] px-1">
      ...
      {/* Barra verde grudada nas bordas - CORREÇÃO APLICADA */}
      <div className="bg-[rgba(39,124,48,1)] w-screen -mx-5 md:-mx-20 py-10 mt-20">
        <div className="max-w-[1567px] mx-auto px-5 md:px-20">
